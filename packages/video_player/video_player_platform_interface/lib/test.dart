  ...
  static void setup(TestHostVideoPlayerApi api) {
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setupMux was null. Expected MuxConfigMessage.');
          final MuxConfigMessage input = MuxConfigMessage.decode(message);
          api.setupMux(input);
          return <Object, Object>{};
        });
      }
