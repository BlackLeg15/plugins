...
public class Messages {
  ...
  public static class CreateMessage {
    ...
    public HashMap getHttpHeaders() { return httpHeaders; }
    public void setHttpHeaders(HashMap setterArg) { this.httpHeaders = setterArg; }
      ...
      }
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              MuxConfigMessage input = MuxConfigMessage.fromMap((HashMap)message);
              api.setupMux(input);
              wrapped.put("result", null);
            }
            catch (Exception exception) {
